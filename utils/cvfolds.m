...
% Constructs a cell of folds, each element having the samples that are left-out for that fold 
%
% Y is the Nx1 response
% family is either 'gaussian' or 'multinomial'
% CVscheme is how many folds you want
% allcs is a two column matrix indicating pairs of related samples
